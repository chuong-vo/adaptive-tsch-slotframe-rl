...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    :param check_freq:
    :param log_dir: Path containing the file created by the ``Monitor`` wrapper.
    :param verbose: Verbosity level.
    :param save_dir: Optional path where the selected model is saved. Keeping
      this separate prevents other callbacks from overwriting the artifact.
    """
    ...
    def __init__(
        ...
        self.save_path = os.path.join(self.save_dir, 'best_model')
